...
std::regex const give_re{
    R"(^bot (\d+) gives low to (bot|output) (\d+) and high to (output|bot) (\d+)$)",
...
template <>
std::string
solve<kDay10>(bool _part1, std::istream& _is, [[maybe_unused]] std::ostream& _os)
{
