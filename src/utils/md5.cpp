...
__forceinline uint32_t MD5::F(uint32_t x, uint32_t y, uint32_t z) {
	return x & y | ~x & z;
}

__forceinline uint32_t MD5::G(uint32_t x, uint32_t y, uint32_t z) {
	return x & z | y & ~z;
}

__forceinline uint32_t MD5::H(uint32_t x, uint32_t y, uint32_t z) {
	return x ^ y ^ z;
}

__forceinline uint32_t MD5::I(uint32_t x, uint32_t y, uint32_t z) {
	return y ^ (x | ~z);
}

// rotate_left rotates x left n bits.
__forceinline uint32_t MD5::rotate_left(uint32_t x, int n) {
	//return (x << n) | (x >> (32 - n));
	return _rotl(x, n);
}
...
__forceinline void MD5::FF(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint32_t s, uint32_t ac) {
	a = rotate_left(a + F(b, c, d) + x + ac, s) + b;
}

__forceinline void MD5::GG(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint32_t s, uint32_t ac) {
	a = rotate_left(a + G(b, c, d) + x + ac, s) + b;
}

__forceinline void MD5::HH(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint32_t s, uint32_t ac) {
	a = rotate_left(a + H(b, c, d) + x + ac, s) + b;
}

__forceinline void MD5::II(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint32_t s, uint32_t ac) {
...
void MD5::Decode(uint32_t* output, uint8_t const* input)
{
...
// a multiple of 4.
void MD5::Encode(uint8_t* output, uint32_t const* input, size_type len)
{
...
void MD5::Update(uint8_t const* input, size_type length)
{
...
void MD5::Update(int8_t const* input, size_type length)
{
